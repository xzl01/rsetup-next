...
At 1080px the route dock narrows and lower overview bands span the grid. At 860px the overview becomes one column and operation rows form a two-column group. At 780px the route dock becomes a six-item, 64px bottom dock; the workspace and status bar account for it, and dense tables collapse secondary metadata. At 560px, including the reviewed 390px viewport, the board-health stage grows vertically, operation and capability lists become single-column, panel gutters contract to 20px, and the status bar remains above the bottom dock.
