(() => {
  const dictionaries = {
    en: {
      ...
      "sources.benchmark": "Test mirrors",
      "sources.benchmarkTitle": "Mirror speed test",
      "sources.benchmarkNote": "Index samples from this SBC, not peak bandwidth. Up to 1 MiB per mirror; settings stay unchanged.",
      "sources.stopTest": "Stop testing",
      "sources.testing": "Testing {done}/{total}…",
      "sources.stoppingTest": "Finishing current mirror… {done}/{total}",
      "sources.testStopped": "Stopped · {done}/{total}",
      "sources.testComplete": "Completed · {done}/{total}",
      "sources.simulatedTest": "Simulated test",
      "sources.benchmarkStale": "Source configuration changed. Refresh and test again.",
      "sources.chooseTested": "Select {name}",
      "sources.noTestTarget": "No applicable source entries",
      "sources.systemProbe": "System",
      "sources.latency": "Response",
      "sources.sampleSpeed": "Sample",
      "sources.testStatus.ok": "Available",
      "sources.testStatus.timeout": "Timed out · Retry",
      "sources.testStatus.http_error": "Index unavailable",
      "sources.testStatus.network_error": "Network or TLS error · Retry",
      "sources.testStatus.invalid_index": "Not a package index",
      "sources.testStatus.sample_too_large": "Sample exceeds limit",
      "sources.testStatus.curl_missing": "Install curl and retry",
    ...
    "zh-CN": {
      ...
      "sources.benchmark": "镜像测速",
      "sources.benchmarkTitle": "镜像测速",
      "sources.benchmarkNote": "由本机 SBC 采样索引，速率不代表带宽上限。每个镜像最多采样 1 MiB，不修改配置。",
      "sources.stopTest": "停止测速",
      "sources.testing": "正在测速 {done}/{total}…",
      "sources.stoppingTest": "正在结束当前镜像… {done}/{total}",
      "sources.testStopped": "已停止 · {done}/{total}",
      "sources.testComplete": "已完成 · {done}/{total}",
      "sources.simulatedTest": "模拟测速",
      "sources.benchmarkStale": "源配置已变化，请刷新后重新测速。",
      "sources.chooseTested": "选择 {name}",
      "sources.noTestTarget": "无可测试的源条目",
      "sources.systemProbe": "系统",
      "sources.latency": "响应",
      "sources.sampleSpeed": "采样速率",
      "sources.testStatus.ok": "可用",
      "sources.testStatus.timeout": "连接超时 · 请重试",
      "sources.testStatus.http_error": "索引不可访问",
      "sources.testStatus.network_error": "网络或 TLS 错误 · 请重试",
      "sources.testStatus.invalid_index": "返回内容不是软件包索引",
      "sources.testStatus.sample_too_large": "样本超出大小限制",
      "sources.testStatus.curl_missing": "请安装 curl 后重试",
