(() => {
  const dictionaries = {
    en: {
      ...
      "route.help": "FAQ",
      "route.help.detail": "Board guides, answers, and support channels",
      "help.title": "Help & support",
      "help.lede": "Official resources and practical answers for the connected board.",
      "help.boardBadge": "{board} · {soc}",
      "help.libraryTitle": "{board} help",
      "help.libraryDescription": "Official resources selected for {board}.",
      "help.libraryGeneric": "No exact board match yet. Showing Radxa-wide resources.",
      "help.faq.title": "Frequently asked questions",
      "help.faq.scope": "For this board",
      ...
      "help.faq.support.answer": "Share the board model, operating system, kernel, and relevant Activity entry. Never post passwords, access tokens, or private keys.",
      "help.resource.guide.title": "Product guide",
      "help.resource.guide.description": "Setup and board reference",
      ...
      "hardware.unavailable": "This hardware tool is unavailable on the current board.",
      ...
      "overlay.warning.kernel": "A kernel update may restore the board's default overlays.",
      ...
      "thermal.policyHint.power_allocator": "Recommended for fanless boards or DC fans",
      ...
      "api.hardware_unsupported": "This hardware tool is unavailable on the current board.",
    ...
    "zh-CN": {
      ...
      "help.faq.support.answer": "请提供开发板型号、系统版本、内核和相关活动记录；不要发布密码、访问令牌或私钥。",
      "help.resource.guide.title": "产品指南",
      "help.resource.guide.description": "安装步骤与开发板参考",
      ...
      "hardware.open": "打开工具",
      "hardware.unavailable": "当前开发板不支持此硬件工具。",
      ...
      "overlay.warning.kernel": "内核更新可能恢复开发板默认叠加层。",
      ...
      "api.hardware_unsupported": "当前开发板不支持此硬件工具。",
