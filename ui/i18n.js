(() => {
  const dictionaries = {
    en: {
      ...
      "gpio.description": "Read-only view of the expansion header and current line levels.",
      "gpio.chips": "{count} GPIO chips",
      "gpio.serialWarning": "A serial console uses GPIO pins. This view does not change any line.",
      "gpio.pin": "Physical pin {pin}",
      "gpio.unmapped": "Not mapped",
      "gpio.low": "Low",
      "gpio.high": "High",
      "gpio.unknown": "Not sampled",
      ...
      "thermal.description": "Monitor thermal zones and choose the kernel cooling policy.",
    ...
    "zh-CN": {
      ...
      "gpio.description": "只读显示扩展排针映射和当前电平。",
      "gpio.chips": "{count} 个 GPIO 芯片",
      "gpio.serialWarning": "串口控制台正在占用 GPIO 引脚；此页面不会改变任何线路。",
      "gpio.pin": "物理引脚 {pin}",
      "gpio.unmapped": "未映射",
      "gpio.low": "低电平",
      "gpio.high": "高电平",
      ...
      "thermal.description": "查看温区，并选择内核散热策略。",
