...
const EXPECTED = {
  "en-US": {
    ...
    "storageTool.permissionDenied": "Permission denied",
    "storageTool.readFailed": "Read failed",
    "storageTool.protocolError": "Device protocol error",
  ...
  "zh-CN": {
    ...
    "storageTool.permissionDenied": "权限不足",
    "storageTool.readFailed": "读取失败",
    "storageTool.protocolError": "设备协议错误",
